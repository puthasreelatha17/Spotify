...
public class GetAlbums extends BaseTest{
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Spotify where REQUEST ='get albums'")
	...
	public void test(String SL_No, String REQUEST,String ids) {
		...
		Response response=ApiActionUtil.getMethodAddValue( Endpoints.GETALBUMS,ids);
