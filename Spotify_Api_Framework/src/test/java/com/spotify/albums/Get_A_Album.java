...
public class Get_A_Album extends BaseTest{
	...
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from Spotify where REQUEST ='get album'")
	...
	public void test(String SL_No, String REQUEST,String ids) {
		...
		Response response=ApiActionUtil.getMethodAddValue( Endpoints.GET_A_ALBUM,ids);
